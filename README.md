...
```shell
npm install https://github.com/siliconswampio/sbr-client.git
```
...
```typescript
import { Config, EthereumClient } from '@sbr/client'
...
You can also provide your custom [@sbr/vm](https://github.com/ethereumjs/ethereumjs-monorepo/tree/master/packages/vm) instance:
